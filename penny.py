...
def cmd_delete(args, tracker):
    ...
    result = tracker.delete_expense(args.display_id)
...
Examples:
  ...
  penny delete 2
    ...
    filter_parser.add_argument('--from', dest='date_from', help='Start date (DD-MM-YYYY)')
    ...
    summary_parser.add_argument('--year', required=True, type=int, help='Year (e.g., 2026)')
    
    # Edit command
    edit_parser = subparsers.add_parser('edit', help='Edit expense by display ID')
    edit_parser.add_argument('display_id', type=int, help='Display ID from view command')
    ...
    delete_parser.add_argument('display_id', type=int, help='Display ID from view command')
